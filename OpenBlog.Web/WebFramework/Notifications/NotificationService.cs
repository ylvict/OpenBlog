...
namespace OpenBlog.Web.WebFramework.Notifications
{
    /// <summary>
    ...
    public partial class NotificationService : INotificationService
    {
        ...
        protected virtual void PrepareTempData(NotifyType type, string message, bool encode = true)
        {
            ...
            var messages = tempData.ContainsKey(MessageDefaults.NotificationListKey)
                ? JsonConvert.DeserializeObject<IList<NotifyData>>(
                    tempData[MessageDefaults.NotificationListKey].ToString() ?? string.Empty)
                : new List<NotifyData>();
